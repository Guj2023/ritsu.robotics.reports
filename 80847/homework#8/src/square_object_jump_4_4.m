...
% ê≥ï˚å`íeê´ï®ëÃÇÃíµñÙ (4&times;4)
% g, cm, sec
...
for t = 0:0.1:tp+th+tf
    ...
    pbaspect([1 2 1]);
    grid on;
    filename = strcat('jump_4_4/deform_', num2str(floor(1000*t),'%04d'), '.png');
...
v = VideoWriter('square_object_jump_4_4', 'MPEG-4');
open(v);
writeVideo(v, M);
close(v);
