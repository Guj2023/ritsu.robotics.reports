...
qinit = q1(end,:);
save('ring_and_springs_period01.mat', 't1', 'q1', '-v7.3');
clear t1 q1;
...
qinit = q2(end,:);
save('ring_and_springs_period12.mat', 't2', 'q2', '-v7.3');
clear t2 q2;
...
qinit = q3(end,:);
save('ring_and_springs_period23.mat', 't3', 'q3', '-v7.3');
clear t3 q3;
...
qinit = q4(end,:);
save('ring_and_springs_period34.mat', 't4', 'q4', '-v7.3');
clear t4 q4;
...
qinit = q5(end,:);
save('ring_and_springs_period45.mat', 't5', 'q5', '-v7.3');
clear t5 q5;
