function dotq = closed_mechanism_2DOF_PD_params (t, q, robot, thetad, Kp, Kd)
% equation of motion of 2DOF closed mechanism under PD control
    ...
    tau_left  = [ -Kp(1)*(theta(1) - thetad(1)) - Kd(1)*omega(1); 0 ];
    tau_right = [ -Kp(2)*(theta(3) - thetad(2)) - Kd(2)*omega(3); 0 ];
