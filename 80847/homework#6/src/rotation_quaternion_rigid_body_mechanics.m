...
function making_video (body, time, s, videostep)
    ...
    v = VideoWriter('/Users/jun/Documents/80847/homework#6/assets/rotation_quaternion', 'MPEG-4');
    open(v);
    writeVideo(v, M);
    close(v);
end
...
function making_tiled_video (body, time, s, videostep)
    ...
    for t=ts:videostep:tf
        ...
        % Save figure every 5 seconds
        if mod(t, 4) == 0
            saveas(gcf, sprintf('/Users/jun/Documents/80847/homework#6/assets/figure_%d.png', round(t)));
        end
    end
    M(fr) = getframe(gcf);
    
    v = VideoWriter('/Users/jun/Documents/80847/homework#6/assets/rotation_quaternion_tiled', 'MPEG-4');
    open(v);
    writeVideo(v, M);
    close(v);
end
