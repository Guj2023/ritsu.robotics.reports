% PD control of 2DOF closed mechanism
...
thetad = [ pi/3; pi/6 ]; Kp = [ 3; 3 ]; Kd = [ 0.5; 0.5 ];
closed_mechanism_2DOF_PD_ode = @(t,q) closed_mechanism_2DOF_PD_params (t, q, robot, thetad, Kp, Kd);
...
grid on;
saveas(gcf, '/Users/jun/Documents/80847/homework#4/assets/closed_mechanism_2DOF_PD_angles.png');
...
hold off;
saveas(gcf, '/Users/jun/Documents/80847/homework#4/assets/closed_mechanism_2DOF_PD_draw.png');
...
v = VideoWriter('/Users/jun/Documents/80847/homework#4/assets/closed_mechanism_2DOF_PD_draw', 'MPEG-4');
open(v);
writeVideo(v, M);
close(v);
